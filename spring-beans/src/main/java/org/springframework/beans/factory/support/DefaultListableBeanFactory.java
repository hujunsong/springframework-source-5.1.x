...
public class DefaultListableBeanFactory extends AbstractAutowireCapableBeanFactory
	...
	public Object doResolveDependency(DependencyDescriptor descriptor, @Nullable String beanName,
		...
		try {
			 ...
			 * 比如下面的配置：
			 *   <bean name="mongoDao" class="com.wb.spring.autowire.MongoDao" primary="true"/>
			 *   <bean name="service" class="com.wb.spring.autowire.Service" autowire="byType"/>
			 *   <bean name="mysqlDao" class="com.wb.spring.autowire.MySqlDao"/>
			 *
			...
			/**
			 * 返回候选项实例，如果实例是 Class 类型，则调用 beanFactory.getBean(String, Class) 获取相应的 bean。
			 * 否则直接返回即可
			 */
			if (instanceCandidate instanceof Class) {
				// 调用DependencyDescriptor的resolveCandidate方法.
